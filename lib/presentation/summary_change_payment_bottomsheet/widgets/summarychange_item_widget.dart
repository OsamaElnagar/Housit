        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Obx(
                () => CustomIconButton(
                  ...
                  child: CustomImageView(
                    imagePath: summarychangeItemModelObj.checkmark!.value,
                  ),
                ),
              ),
              ...
              Obx(
                () => Text(
                  summarychangeItemModelObj.text!.value,
              ...
              Row(
                ...
                children: [
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Obx(
                          () => Text(
                            summarychangeItemModelObj.balance!.value,
                            style:
                        ...
                        Obx(
                          () => Text(
                            summarychangeItemModelObj.price!.value,
                  ...
                  Obx(
                    () => CustomImageView(
                      imagePath: summarychangeItemModelObj.balance1!.value,
                      height: 20.adaptSize,
                      width: 20.adaptSize,

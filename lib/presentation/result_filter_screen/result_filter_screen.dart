import '../result_filter_screen/widgets/filter_item_widget.dart';import '../result_filter_screen/widgets/layout1_item_widget.dart';import 'controller/result_filter_controller.dart';import 'models/filter_item_model.dart';import 'models/layout1_item_model.dart';import 'package:flutter/material.dart';import 'package:housit/core/app_export.dart';import 'package:housit/widgets/app_bar/appbar_leading_iconbutton.dart';import 'package:housit/widgets/app_bar/appbar_subtitle.dart';import 'package:housit/widgets/app_bar/appbar_trailing_iconbutton_three.dart';import 'package:housit/widgets/app_bar/custom_app_bar.dart';import 'package:housit/widgets/custom_search_view.dart';import 'package:housit/presentation/filter_full_bottomsheet/filter_full_bottomsheet.dart';import 'package:housit/presentation/filter_full_bottomsheet/controller/filter_full_controller.dart';class ResultFilterScreen extends GetWidget<ResultFilterController> {const ResultFilterScreen({Key? key}) : super(key: key);

@override Widget build(BuildContext context) { return SafeArea(child: Scaffold(resizeToAvoidBottomInset: false, appBar: _buildAppBar(), body: Container(width: double.maxFinite, padding: EdgeInsets.symmetric(horizontal: 24.h, vertical: 10.v), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [SizedBox(height: 7.v), CustomSearchView(controller: controller.searchController, hintText: "lbl_modern_house".tr), SizedBox(height: 20.v), _buildItemHeader(), SizedBox(height: 20.v), _buildFilter(), SizedBox(height: 20.v), _buildLayout()])))); } 
/// Section Widget
